...
from monofrd.utils import box_utils, common_utils


class ResidualCoder(object):
    def __init__(self, code_size=7, encode_angle_by_sincos=False, div_by_diagonal=True, use_corners=False,
                 use_tanh=False, tanh_range=3.14, **kwargs):
        super().__init__()
