...
class monofrd(StereoDetector3DTemplate):
    ...
    def get_training_loss(self, batch_dict):
        ...
        loss_nerf_left_rgb, loss_nerf_left_depth, loss_nerf_right_rgb, loss_nerf_right_depth, loss_sdf, tb_dict = self.depth_loss_head.get_loss(
            batch_dict, tb_dict)
        tb_dict = {
