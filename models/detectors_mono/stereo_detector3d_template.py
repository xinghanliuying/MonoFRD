...
from monofrd.models import backbones_2d, backbones_3d_mono, dense_heads
from monofrd.models.backbones_2d import map_to_bev
from monofrd.models.dense_heads.depth_loss_head import DepthLossHead
from monofrd.ops.iou3d_nms import iou3d_nms_utils
from monofrd.utils import nms_utils
from monofrd.utils.common_utils import create_logger

IF_DIST = os.environ.get('IF_DIST', 'Default Value')
...
class StereoDetector3DTemplate(nn.Module):
    ...
    def build_lidar_model(self, model_info_dict):
        ...
        if IF_DIST == "1":
            ...
            logger = create_logger(rank=1)  ####### 修改rank
    ...
    def build_backbone_3d(self, model_info_dict):
        ...
        backbone_3d_module = backbones_3d_mono.__all__[self.model_cfg.BACKBONE_3D.NAME](
    ...
    def build_dense_head(self, model_info_dict):
        ...
        dense_head_module = dense_heads.__all__[self.model_cfg.DENSE_HEAD.NAME](
            ...
            grid_size=model_info_dict['grid_size'],
            point_cloud_range=model_info_dict['point_cloud_range'],
            predict_boxes_when_training=self.model_cfg.get('ROI_HEAD', False) or self.model_cfg.DENSE_HEAD.get(
            ...
            if key not in update_model_state:
                logger.info('Not updated weight %s: %s <- %s' %
                            (key, str(state_dict[key].shape),
                             str(model_state_disk[key].shape) if key in model_state_disk else 'None'))
