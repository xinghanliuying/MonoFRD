...
class MonoDatasetTemplate(torch_data.Dataset):
    def __init__(self, dataset_cfg=None, class_names=None, training=True, root_path=None, logger=None):
        ...
        if self.training:
            if getattr(self.dataset_cfg, 'TRAIN_DATA_AUGMENTOR', None) is not None:
    ...
    def collate_batch(batch_list, _unused=False):
        ...
        for key, val in data_dict.items():
            ...
            elif key in ['left_img', 'depth_gt_img', 'depth_fgmask_img']:
